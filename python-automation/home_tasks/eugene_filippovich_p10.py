...
logging.info(bouquet.get_total_price())
logging.info(bouquet.get_average_life_time())

# bouquet.destruct_bouquet()
# logging.info(bouquet.search_by_key())
logging.info(bouquet.check_contains(p))

b2 = Bouquet()
p2 = Peonies('Purple', 30, 2, 3)
b2.add_flowers(r, p2)
bouquet.sorting_by_key()
# logging.info(bouquet.life_time)
